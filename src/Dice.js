    ...
    render() {
        ...
        return (
            ...
            >
                ...
                <span className="Dot middle left" hidden={val !== 6}></span>
                <span className="Dot center-center" hidden={val !== 1 && val !== 3 && val !== 5 && val !== 6}></span>
                <span className="Dot middle right" hidden={val !== 6}></span>
